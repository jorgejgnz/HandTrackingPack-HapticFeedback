    ...
    public class OVRAnchorVelocityEstimator : VelocityTracker
    {
        ...
        protected override Vector3 DoGetAngularVelocity()
        {
            switch (trackedGameObject.name)
            {
                ...
                case "LeftHandAnchor":
                    return trackedGameObject.transform.rotation * OVRInput.GetLocalControllerAngularVelocity(OVRInput.Controller.LHand);
                case "RightHandAnchor":
                    return trackedGameObject.transform.rotation * OVRInput.GetLocalControllerAngularVelocity(OVRInput.Controller.RHand);
            }
            return Vector3.zero;
        }
        ...
        protected override Vector3 DoGetVelocity()
        {
            switch (trackedGameObject.name)
            {
                ...
                case "LeftHandAnchor":
                    return relativeTo.transform.rotation * OVRInput.GetLocalControllerVelocity(OVRInput.Controller.LHand);
                case "RightHandAnchor":
                    return relativeTo.transform.rotation * OVRInput.GetLocalControllerVelocity(OVRInput.Controller.RHand);
            }
            return Vector3.zero;
        }
    }
